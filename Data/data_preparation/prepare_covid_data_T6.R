...
covid_T6 <- read.spss("Attitudes COVID-19 vaccins_T6_IDrecoded_v2.sav")
...
covid6 <- data.frame(
  CaseID = covid_T6$CaseID,
  time = rep(6, n= 1536),
  Vacc_Aff_2 = covid_T6$Vacc_Aff_2, 
  Vacc_Aff_4 = covid_T6$Vacc_Aff_4, 
  Vacc_Aff_7 = covid_T6$Vacc_Aff_7, 
  Vacc_Cog_1 = covid_T6$Vacc_Cog_1, 
  Vacc_Cog_2 = covid_T6$Vacc_Cog_2, 
  Vacc_Cog_3 = covid_T6$Vacc_Cog_3, 
  Vacc_Cog_4 = covid_T6$Vacc_Cog_4, 
  Vacc_Cog_5 = covid_T6$Vacc_Cog_5, 
  Vacc_Beh_2 = covid_T6$Vacc_Beh_2, 
  Vacc_Beh_3 = covid_T6$Vacc_Beh_3, 
  Vacc_Oth_5 = covid_T6$Vacc_Oth_5, 
  Vacc_Oth_6 = covid_T6$Vacc_Oth_6,
  Vacc_Oth_7 = covid_T6$Vacc_Oth_7,
  Vacc_Oth_8 = covid_T6$Vacc_Oth_8
)

for(col in 2:ncol(covid6)){
  covid6[, col] <- as.numeric(covid6[, col])
}

# compute average attitude 
covid6$mean_attitude <- covid6 %>%
  select(3:13) %>%
  rowSums(.)/11

# compute average involvement 
covid6$mean_involvement <- covid6 %>%
  select(14:16) %>%
  rowSums(.)/3

# save dataframe 
write.csv(covid6,
          "Data/processed_data/covid_T6.csv")
